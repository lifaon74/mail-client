...
} from '../../classes/email-data/built-in/multipart/built-in/create-email-data-multipart-with-autogenerated-boundary';
...
} from '../../classes/email-data/components/header-list/components/header/built-in/bcc/create-email-header-bcc';
import { createEmailHeaderCc } from '../../classes/email-data/components/header-list/components/header/built-in/cc/create-email-header-cc';
import {
  createEmailHeaderDate,
} from '../../classes/email-data/components/header-list/components/header/built-in/date/create-email-header-date';
import {
  createEmailHeaderFrom,
} from '../../classes/email-data/components/header-list/components/header/built-in/from/create-email-header-from';
import {
  createEmailHeaderInReplyTo,
} from '../../classes/email-data/components/header-list/components/header/built-in/in-reply-to/create-email-header-in-reply-to';
import {
  createEmailHeaderMessageId,
} from '../../classes/email-data/components/header-list/components/header/built-in/message-id/create-email-header-message-id';
import {
  createEmailHeaderReferences,
} from '../../classes/email-data/components/header-list/components/header/built-in/references/create-email-header-references';
import {
  createEmailHeaderReplyTo,
} from '../../classes/email-data/components/header-list/components/header/built-in/reply-to/create-email-header-reply-to';
import {
  createEmailHeaderSender,
} from '../../classes/email-data/components/header-list/components/header/built-in/sender/create-email-header-sender';
import {
  createEmailContactList,
} from '../../classes/email-data/components/header-list/components/header/built-in/shared/email-concat/email-contact-list/create-email-contact-list';
import {
  createMessageIdList,
} from '../../classes/email-data/components/header-list/components/header/built-in/shared/message-id/message-id-list/create-message-id-list';
import {
  createEmailHeaderSubject,
} from '../../classes/email-data/components/header-list/components/header/built-in/subject/create-email-header-subject';
import { createEmailHeaderTo } from '../../classes/email-data/components/header-list/components/header/built-in/to/create-email-header-to';
import { IEmailHeader } from '../../classes/email-data/components/header-list/components/header/email-header.type';
import { IEmailData } from '../../classes/email-data/email-data.type';
import { generateMessageIdDomain } from '../../classes/message-id/built-in/domain/create-message-id-domain';
