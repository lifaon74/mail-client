...
const REFACTOR_DIRECTORY_PATH = $path.join(ROOT_PATH, 'src/__debug/codec/grammar/uint8-array-parser/end');

const SIMPLE_REFACTOR_FROM = 'concat';
const SIMPLE_REFACTOR_TO = 'end';
